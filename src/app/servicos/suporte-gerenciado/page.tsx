...
const faqs = [
  {
    ...
    answer: 'MSP é um provedor de serviços gerenciados: assume a responsabilidade pela operação e saúde da infraestrutura de TI do cliente de forma proativa e contínua. Ao contrário do suporte reativo, o MSP monitora, previne, gerencia patches e responde a incidentes como parte de um contrato mensal com SLAs definidos.',
  },
  {
    question: 'Qual é o tempo de resposta do suporte gerenciado da JPX Digital?',
    answer: 'Os SLAs variam por criticidade: incidentes críticos têm resposta em até 1 hora. Incidentes de alta prioridade têm resposta em 4 horas. Para clientes com suporte 24x7, os SLAs são mantidos fora do horário comercial.',
  },
  {
    question: 'O suporte gerenciado substitui uma equipe interna de TI?',
    answer: 'Depende do contexto. Para empresas sem equipe interna, pode ser o substituto completo. Para empresas com equipe pequena, funciona como extensão — JPX Digital assume monitoramento, patching, backup e incidentes N2/N3, liberando a equipe interna para projetos estratégicos.',
  },
  {
    question: 'O que está incluído no suporte gerenciado?',
    answer: 'Pacote padrão inclui: monitoramento proativo 8x5, gestão de patches, gestão de backup com testes periódicos, resposta a incidentes dentro do SLA, relatório mensal de disponibilidade e reunião mensal de alinhamento. Atendimento 24x7 e outros serviços são adicionados conforme necessidade.',
  },
  {
    question: 'Como é feita a transição para o suporte gerenciado?',
    answer: 'Realizamos um onboarding estruturado de 30-60 dias: inventário completo do ambiente, documentação do que não está documentado, instalação de agentes de monitoramento e revisão de configurações de backup. Só assumimos SLA após ter visibilidade completa do ambiente.',
  },
]
...
const content: ServicePageContent = {
  ...
  ctaLabel: 'Solicitar Assessment de Ambiente',

  problem: {
    headline: 'Não faz sentido ter uma equipe interna de TI de plantão 24h. Mas alguém precisa estar olhando para o seu ambiente — sempre.',
    body: [
      ...
      'Cada contrato começa com um onboarding completo do ambiente: documentamos o que não está documentado, instalamos monitoramento e só assumimos SLA depois de ter visibilidade total do que gerenciamos.',
    ],
  },

  assessment: {
    name: 'Assessment de Ambiente Gerenciado',
    body: 'Antes de assumir qualquer SLA, realizamos um inventário completo do seu ambiente. Mapeamos todos os sistemas, documentamos o que não está documentado e identificamos riscos existentes. Você sabe exatamente o que está sendo gerenciado.',
    checklist: [
      'Inventário completo de hardware e software',
      'Auditoria de configurações de backup e monitoramento',
      'Identificação de riscos e pontos de atenção',
      'Definição de SLAs por criticidade de sistema',
      'Plano de onboarding e transição estruturado',
    ],
  },

  process: {
    title: 'Como funciona o suporte gerenciado',
    steps: [
  ...
  benefits: [
    { title: 'TI previsível', desc: 'Custo mensal fixo, SLA documentado, sem surpresas de custo ou disponibilidade.' },
    { title: 'Monitoramento proativo', desc: 'Problemas identificados e resolvidos antes de impactar usuários e operação.' },
    { title: 'Documentação viva', desc: 'Ambiente sempre documentado. Nenhuma informação crítica na cabeça de uma única pessoa.' },
    { title: 'Foco no negócio', desc: 'Sua equipe interna foca em projetos estratégicos; a operação fica conosco.' },
  ],

  deliverables: [
    'Relatório de Assessment de Ambiente',
    'Inventário documentado de ativos',
    'Runbooks de incidentes por sistema crítico',
    'Dashboard de monitoramento e alertas',
    'Relatório mensal de disponibilidade',
    'Registro de patches e atualizações aplicadas',
    'Plano de capacidade trimestral',
  ],

  differentials: [
    { title: 'SLA de resposta documentado', desc: 'Tempo de resposta por criticidade registrado em contrato. Crítico: até 1 hora. Alta: até 4 horas. Normal: até 8 horas em dias úteis.' },
    { title: 'Monitoramento proativo, não reativo', desc: 'Alertas configurados para detectar problemas antes do impacto: disco se enchendo, memória alta, serviços anômalos, backups com falha.' },
    { title: 'Onboarding com inventário completo', desc: 'Não assumimos gerenciamento de ambientes que não documentamos. O onboarding inclui inventário completo — quando descobrimos o que estava sendo ignorado há anos.' },
