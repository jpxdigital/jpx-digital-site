...
const slug = 'business-continuity'

const faqs = [
  {
    question: 'Qual é a diferença entre Business Continuity e Disaster Recovery?',
    answer: 'Disaster Recovery é focado em recuperar sistemas de TI após um incidente. Business Continuity é mais amplo: abrange pessoas, processos, comunicação, fornecedores e clientes — não apenas tecnologia. Um plano de BC define como a empresa continua operando durante e após qualquer tipo de interrupção, seja técnica, operacional ou de força maior.',
  },
  {
    question: 'Minha empresa precisa de um BCP formal?',
    answer: 'Se a sua operação depende de sistemas de TI, de funcionários-chave ou de fornecedores críticos, sim. Setores como saúde, financeiro, jurídico e industrial frequentemente têm exigências regulatórias de BCP. Mas qualquer empresa que não pode se dar ao luxo de ficar parada por dias deve ter ao menos um plano básico documentado.',
  },
  {
    question: 'O BCP cobre ausência de funcionários-chave?',
    answer: 'Sim. Um BCP bem estruturado mapeia dependências de pessoas — quem sabe fazer o quê, quem pode substituir quem — e define planos de redundância de conhecimento. Inclui documentação de processos críticos para que outros possam executá-los em caso de ausência inesperada.',
  },
  {
    question: 'Com que frequência o BCP deve ser atualizado e testado?',
    answer: 'Recomendamos revisão anual do plano e testes (tabletop exercises ou simulações reais) semestrais. Qualquer mudança significativa na infraestrutura, equipe ou processos da empresa deve disparar uma revisão do BCP. Um plano desatualizado pode ser mais perigoso do que não ter plano.',
  },
  {
    question: 'Como integrar BCP com exigências de compliance e certificações?',
    answer: 'O BCP é requisito em várias normas: ISO 22301 (Business Continuity Management), ISO 27001 (Segurança da Informação), SOC 2 Type II e regulamentações setoriais (CFM, BACEN, SUSEP). A JPX Digital documenta o BCP alinhado a esses frameworks, facilitando auditorias e certificações.',
  },
]
...
const content: ServicePageContent = {
  ...
  schemas: [
    ...
    breadcrumbSchema([{ name: 'Home', item: BASE }, { name: 'Serviços', item: `${BASE}/servicos` }, { name: 'Business Continuity', item: `${BASE}/servicos/${slug}` }]),
    faqPageSchema(faqs),
  ],
}
