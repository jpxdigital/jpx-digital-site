...
const content: ServicePageContent = {
  ...
  ctaLabel: 'Solicitar Industrial IT Assessment',

  problem: {
    headline: 'A transformação digital conectou o chão de fábrica à internet — e com ela, trouxe os riscos de TI para dentro da produção.',
    body: [
      'CLPs, SCADA e MES estão cada vez mais ligados às redes corporativas e à internet. O que antes era um ambiente isolado agora é uma superfície de ataque. Ransomware em rede OT não pede aviso — paralisa a produção.',
      'ERP, BI e sistemas de qualidade dependem de dados em tempo real da produção. Integração mal feita gera relatórios incorretos e decisões erradas — sem que ninguém perceba até causar impacto.',
  ...
  assessment: {
    name: 'Industrial IT Assessment',
    body: 'Inventariamos a infraestrutura de TI corporativa e os ativos de OT (CLPs, IHMs, supervisórios, redes de automação), mapeamos os pontos de integração existentes e identificamos riscos de segurança e disponibilidade em cada camada. Você recebe um diagnóstico com plano de adequação priorizado.',
    checklist: [
      'Inventário de ativos IT e OT (CLPs, IHMs, supervisórios)',
      'Mapeamento dos pontos de integração entre redes IT e OT',
      'Análise de segmentação de rede e exposição da rede OT',
      'Auditoria de backup de configurações de CLP e supervisório',
      'Avaliação de disponibilidade por sistema crítico de produção',
    ],
  },

  process: {
    title: 'Como atuamos em ambientes industriais',
    steps: [
  ...
  benefits: [
    { title: 'Rede OT protegida', desc: 'Segmentação IT/OT com firewall industrial. A rede de automação não tem acesso direto à internet.' },
    { title: 'Backup do chão de fábrica', desc: 'Configurações de CLP, programas e documentação — o que não está no backup corporativo e é impossível de recriar.' },
    { title: 'Dados de produção confiáveis', desc: 'Integração ERP/MES validada com qualidade de dados. Decisões baseadas em números corretos.' },
    { title: 'Disponibilidade calculada', desc: 'Nível de HA proporcional ao custo de parada por sistema. Alta disponibilidade onde realmente importa.' },
  ],

  deliverables: [
    'Relatório de Industrial IT Assessment',
    'Mapa de ativos IT/OT com pontos de integração',
    'Arquitetura de segmentação IT/OT',
    'Configuração de backup de sistemas de controle',
    'Documentação de configurações de CLP e supervisório',
    'Plano de contingência para operação sem TI',
  ],
