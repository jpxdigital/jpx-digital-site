...
| P14 | 🟡 Portal white-label do Acronis em andamento — domínio definido: **`resiliencia.jpxdigital.com.br`** (não `suporte`, ver decisão de marca no CHANGELOG 14/09). Marca: "JPX Digital / Data Resilience". CNAME configurado, certificado Let's Encrypt sendo emitido pelo Acronis | Comercial/Infra | Fase 2 |
| P15 | 🆕 Automatizar o fluxo de "cota excedida" do Acronis: botão "Comprar" aponta pra `jpxdigital.com.br/contato`; falta o formulário ler um parâmetro de URL (ex: `?interesse=upsell-acronis`) pra pré-marcar/identificar esses leads como upsell no HubSpot, distinguindo de contato orgânico novo | Site/Comercial | Fase 2 |
