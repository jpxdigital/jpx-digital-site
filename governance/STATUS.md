...
| P14 | 🟡 Portal white-label do Acronis em andamento — domínio definido: **`resiliencia.jpxdigital.com.br`** (não `suporte`, ver decisão de marca no CHANGELOG 14/09). Marca: "JPX Digital / Data Resilience". Falta: CNAME no Cloudflare (aguardando instrução do Acronis) | Comercial/Infra | Fase 2 |
