...
const allServices = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/servicos/sala-cofre', icon: ShieldCheck, title: 'Sala Cofre Nível 4', desc: 'Implantação, manutenção periódica e auditoria EN 1047-2 para ambientes regulados.' },
    ],
  },
  {
