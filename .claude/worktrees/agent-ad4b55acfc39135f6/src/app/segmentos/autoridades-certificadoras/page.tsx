          ...
          <div className="container-page">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                { titulo: 'Sala Cofre e Segurança Física', desc: 'Projetamos e implementamos a sala cofre conforme EN 1047-2 e DOC-ICP-04.01: resistência ao fogo, controle de acesso biométrico com dupla custódia, CFTV auditável e supressão de incêndio sem danos ao HSM.' },
